...
During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)**I will keep practicing the clean code that will help in implementing in my project. So that it reduces the complexity,modularity and identifying the code that can be tested Thank you.**
